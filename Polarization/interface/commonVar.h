...
Double_t etaPS = 2.4; //pseudo-rap cuts for muons: used up to 2 July 2010
Double_t pTMuMin = 0.;
Double_t rapYPS = 2.3;
/* Double_t cosThCSCut = 0.8; */
/* Double_t cosThHXCut = 0.8; */
...
/* Int_t const kNbRapBins = 5; */
/* Double_t rapRange[2*kNbRapBins+1] = {-2.4, -1.85, -1.55, -1.2, -0.75, 0., 0.75, 1.2, 1.55, 1.85, 2.4}; */
/* Double_t rapWCentre[2*kNbRapBins+1] = {-2.036, -1.697, -1.356, -0.959, -0.410, 0., 0.410, 0.959, 1.356, 1.697, 2.036}; */
Int_t const kNbRapBins = 4;
Double_t rapRange[2*kNbRapBins+1] = {-2.3, -1.5, -0.9, 0., 0.9, 1.5, 2.3};

//Double_t rapForPTRange[kNbRapForPTBins+1] = {0., 0.9, 1.5, 2.3};
//Double_t rapForPTRange[kNbRapForPTBins+1] = {0., 0.9, 1.3, 2.3};
Double_t rapForPTRange[kNbRapForPTBins+1] = {0., 0.9, 1.5, 2.3};
...
//phi for pol. 
//Int_t const nBinsPhiPol = 42;
//Double_t phiPolMin = -3.15, phiPolMax = 3.15;
...
Int_t colour_rap[2*kNbRapBins+1] = {1, 2, 3, 3, 2};
Int_t marker_rap[2*kNbRapBins+1] = {20, 20, 21, 23, 25, 24};
