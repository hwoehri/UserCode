...
Int_t PolData2::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PolData2::LoadTree(Long64_t entry)
{
...
void PolData2::Show(Long64_t entry)
{
...
Int_t PolData2::Cut(Long64_t entry)
{
