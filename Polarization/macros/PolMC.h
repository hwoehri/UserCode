...
Int_t PolMC::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PolMC::LoadTree(Long64_t entry)
{
...
void PolMC::Show(Long64_t entry)
{
...
Int_t PolMC::Cut(Long64_t entry)
{
