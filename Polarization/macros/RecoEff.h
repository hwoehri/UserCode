...
Int_t RecoEff::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t RecoEff::LoadTree(Long64_t entry)
{
...
void RecoEff::Show(Long64_t entry)
{
...
Int_t RecoEff::Cut(Long64_t entry)
{
