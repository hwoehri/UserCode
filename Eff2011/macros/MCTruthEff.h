...
#ifdef MCTruthEff_cxx
MCTruthEff::MCTruthEff(TTree *tree)
{
...
MCTruthEff::~MCTruthEff()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MCTruthEff::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MCTruthEff::LoadTree(Long64_t entry)
{
...
void MCTruthEff::Init(TTree *tree)
{
...
void MCTruthEff::Show(Long64_t entry)
{
...
Int_t MCTruthEff::Cut(Long64_t entry)
{
