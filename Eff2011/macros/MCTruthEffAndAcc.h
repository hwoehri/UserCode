...
#ifndef MCTruthEffAndAcc_h
#define MCTruthEffAndAcc_h
...
public :
   ...
   MCTruthEffAndAcc(TTree *tree=0);
   virtual ~MCTruthEffAndAcc();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(Int_t resonance, Int_t trigTime, Bool_t rejectCowboys, Int_t nSigma, Int_t useSoftMuons);
...
#ifdef MCTruthEffAndAcc_cxx
MCTruthEffAndAcc::MCTruthEffAndAcc(TTree *tree)
{
...
MCTruthEffAndAcc::~MCTruthEffAndAcc()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MCTruthEffAndAcc::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MCTruthEffAndAcc::LoadTree(Long64_t entry)
{
...
void MCTruthEffAndAcc::Init(TTree *tree)
{
...
Bool_t MCTruthEffAndAcc::Notify()
{
...
void MCTruthEffAndAcc::Show(Long64_t entry)
{
...
Int_t MCTruthEffAndAcc::Cut(Long64_t entry)
{
...
#endif // #ifdef MCTruthEffAndAcc_cxx
