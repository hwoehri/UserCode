...
#include "TnPDimuonEff_flatGen.C"
...
// void DivideHistos();
//======================================
void runTnPDimuonEff_flatGen(Char_t *fileNameOut = "TnPDimuonEff_flatGen_HLTMu0TkMu0OSTJpsi_18May2011.root",
			 Int_t effSample = MC, //DATA, MC, MCTRUTH
			 Bool_t rejectCowboys = kTRUE,
			 Int_t muSelectionCuts = 0, //0... LOOSE, 1... TIGHT
			 Char_t *trigLabel = "HLT_Mu0_TkMu0_OST_Jpsi", //"HLT_DoubleMu0", "HLT_Mu0_TkMu0_OST_Jpsi",
			 Char_t *fileNameIn = "/Users/hwoehri/CMS/CMSSW/hWoehri/Polarization/macros/jpsiGun_WithFSR_Tree.root"
  ...
  TnPDimuonEff_flatGen tree(treeData);  printf("...done\n");
  ...
  tree.Loop(effSample, trigLabel, rejectCowboys, muSelectionCuts);
...
//   for(int iFrame = 0; iFrame < eff::kNbFrames; iFrame++){
  ...
  //efficiencies vs pT, y and phi and 2D
