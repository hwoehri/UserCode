...
void BookHistos(Char_t *oniaLabel){
  ...
  //1D distributions: 
  //======================================================
  recoEff_pT = new TEfficiency("recoEff_pT", ";p_{T} [GeV/c]", eff::nBinsPt1D, eff::pT1D);
  recoEff_y = new TEfficiency("recoEff_y", ";y", eff::nBinsRap1D_NP, eff::rap1D_NP);
  recoEff_phi = new TEfficiency("recoEff_phi", ";#phi", eff::nBinsPhi1D, eff::phiMin, eff::phiMax);
  //
  trigEff_pT = new TEfficiency("trigEff_pT", ";p_{T} [GeV/c]", eff::nBinsPt1D, eff::pT1D);
  trigEff_y = new TEfficiency("trigEff_y", ";y", eff::nBinsRap1D_NP, eff::rap1D_NP);
  trigEff_phi = new TEfficiency("trigEff_phi", ";#phi", eff::nBinsPhi1D, eff::phiMin, eff::phiMax);
  //
  totEff_pT = new TEfficiency("totEff_pT", ";p_{T} [GeV/c]", eff::nBinsPt1D, eff::pT1D);
  totEff_y = new TEfficiency("totEff_y", ";y", eff::nBinsRap1D_NP, eff::rap1D_NP);
  totEff_phi = new TEfficiency("totEff_phi", ";#phi", eff::nBinsPhi1D, eff::phiMin, eff::phiMax);

  //======================================================
  //2D distributions: 
  //======================================================
  recoEff2D_pT_rapNP = new TEfficiency("recoEff2D_pT_rapNP", ";y;p_{T} [GeV/c]", eff::nBinsRap2D_NP, eff::rap2D_NP, eff::nBinsPt2D, eff::pT2D);
  recoEff2D_pT_rap = new TEfficiency("recoEff2D_pT_rap", ";|y|;p_{T} [GeV/c]", eff::nBinsRap2D, eff::rap2D, eff::nBinsPt2D, eff::pT2D);
  trigEff2D_pT_rapNP = new TEfficiency("trigEff2D_pT_rapNP", ";y;p_{T} [GeV/c]", eff::nBinsRap2D_NP, eff::rap2D_NP, eff::nBinsPt2D, eff::pT2D);
  trigEff2D_pT_rap = new TEfficiency("trigEff2D_pT_rap", ";|y|;p_{T} [GeV/c]", eff::nBinsRap2D, eff::rap2D, eff::nBinsPt2D, eff::pT2D);
  totEff2D_pT_rapNP = new TEfficiency("totEff2D_pT_rapNP", ";y;p_{T} [GeV/c]", eff::nBinsRap2D_NP, eff::rap2D_NP, eff::nBinsPt2D, eff::pT2D);
  totEff2D_pT_rap = new TEfficiency("totEff2D_pT_rap", ";|y|;p_{T} [GeV/c]", eff::nBinsRap2D, eff::rap2D, eff::nBinsPt2D, eff::pT2D);
