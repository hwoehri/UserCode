...
#ifndef DataTnPTriggerEff_h
#define DataTnPTriggerEff_h
...
public :
   ...
   DataTnPTriggerEff(TTree *tree=0);
   virtual ~DataTnPTriggerEff();
...
#ifdef DataTnPTriggerEff_cxx
DataTnPTriggerEff::DataTnPTriggerEff(TTree *tree)
{
...
DataTnPTriggerEff::~DataTnPTriggerEff()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t DataTnPTriggerEff::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t DataTnPTriggerEff::LoadTree(Long64_t entry)
{
...
void DataTnPTriggerEff::Init(TTree *tree)
{
...
Bool_t DataTnPTriggerEff::Notify()
{
...
void DataTnPTriggerEff::Show(Long64_t entry)
{
...
Int_t DataTnPTriggerEff::Cut(Long64_t entry)
{
...
#endif // #ifdef DataTnPTriggerEff_cxx
