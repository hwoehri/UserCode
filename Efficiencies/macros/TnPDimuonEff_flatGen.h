...
#ifndef TnPDimuonEff_flatGen_h
#define TnPDimuonEff_flatGen_h
...
public :
   ...
   TnPDimuonEff_flatGen(TTree *tree=0);
   virtual ~TnPDimuonEff_flatGen();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(Int_t effSample, Char_t *trigLabel, Bool_t rejectCowboys, Int_t muSelectionCuts);
...
#ifdef TnPDimuonEff_flatGen_cxx
TnPDimuonEff_flatGen::TnPDimuonEff_flatGen(TTree *tree)
{
...
TnPDimuonEff_flatGen::~TnPDimuonEff_flatGen()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TnPDimuonEff_flatGen::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TnPDimuonEff_flatGen::LoadTree(Long64_t entry)
{
...
void TnPDimuonEff_flatGen::Init(TTree *tree)
{
...
Bool_t TnPDimuonEff_flatGen::Notify()
{
...
void TnPDimuonEff_flatGen::Show(Long64_t entry)
{
...
Int_t TnPDimuonEff_flatGen::Cut(Long64_t entry)
{
...
#endif // #ifdef TnPDimuonEff_flatGen_cxx
