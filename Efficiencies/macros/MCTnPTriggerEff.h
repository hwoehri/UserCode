...
#ifndef MCTnPTriggerEff_h
#define MCTnPTriggerEff_h
...
public :
   ...
   MCTnPTriggerEff(TTree *tree=0);
   virtual ~MCTnPTriggerEff();
...
#ifdef MCTnPTriggerEff_cxx
MCTnPTriggerEff::MCTnPTriggerEff(TTree *tree)
{
...
MCTnPTriggerEff::~MCTnPTriggerEff()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MCTnPTriggerEff::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MCTnPTriggerEff::LoadTree(Long64_t entry)
{
...
void MCTnPTriggerEff::Init(TTree *tree)
{
...
void MCTnPTriggerEff::Show(Long64_t entry)
{
...
Int_t MCTnPTriggerEff::Cut(Long64_t entry)
{
...
#endif // #ifdef MCTnPTriggerEff_cxx
